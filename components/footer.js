        ...
        <div className='flex-row'>
          <div className="py-28 flex flex-col lg:flex-row items-center">
            ...
            <div className='w-4/5 flex-col text-left mx-10 mb-10'>
              ...
              <p>I'm currently a master's student in Computer Science and Engineering at UC San Diego. I plan on graduating on December of 2022 and is actively looking for software engineering and machine learning positions in the United States.</p>
            </div>
            <div className="flex flex-col lg:flex-row justify-center items-center lg:pl-4 lg:w-1/2">
              <a
                href="/assets/pdf/curriculum_vitae.pdf"
                className="mx-3 my-3 bg-black hover:bg-white hover:text-black border border-black text-white font-bold py-3 px-12 lg:px-8 duration-200 transition-colors mb-6 lg:mb-0"
              >
                Resume
              </a>
              <a
